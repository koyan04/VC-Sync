...
public sealed class AppConfig
{
    ...
    public string ApiKeyDestinationFolder { get; set; } = string.Empty;
    public string ApiKeySourcePath { get; set; } = string.Empty;
    public int RetentionCount { get; set; } = 1;
    public bool BackupConfigOnly { get; set; }
    public bool BackupServerConfigOnly { get; set; }
    public bool RestoreConfigOnly { get; set; }
    public bool RestoreServerConfigOnly { get; set; }
